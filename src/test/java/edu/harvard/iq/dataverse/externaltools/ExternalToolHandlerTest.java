...
public class ExternalToolHandlerTest {
    ...
    public void testGetToolUrlWithOptionalQueryParameters() {
        ...
        try {
            ExternalToolHandler externalToolHandler1 = new ExternalToolHandler(externalTool, nullDataFile, nullApiToken, nullFileMetadata,null);
        } catch (Exception ex) {
        ...
        try {
            ExternalToolHandler externalToolHandler2 = new ExternalToolHandler(externalTool, nullDataFile, nullApiToken, nullFileMetadata, null);
        } catch (Exception ex) {
        ...
        ExternalToolHandler externalToolHandler3 = new ExternalToolHandler(externalTool, dataFile, apiToken, nullFileMetadata, null);
        ...
        externalTool.setToolParameters(Json.createObjectBuilder()
                ...
                .build().toString());
        ExternalToolHandler externalToolHandler6 = new ExternalToolHandler(externalTool, dataFile, apiToken, fmd, null);
        ...
        externalTool.setToolParameters(Json.createObjectBuilder()
                ...
                .build().toString());
        ExternalToolHandler externalToolHandler4 = new ExternalToolHandler(externalTool, dataFile, nullApiToken, nullFileMetadata, null);
        ...
        try {
            ExternalToolHandler externalToolHandler5 = new ExternalToolHandler(externalTool, dataFile, nullApiToken, nullFileMetadata, null);
