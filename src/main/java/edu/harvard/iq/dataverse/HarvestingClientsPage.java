...
public class HarvestingClientsPage implements java.io.Serializable {
    ...
    public void createClient(ActionEvent ae) {
        ...
        newHarvestingClient.setArchiveDescription(BundleUtil.getStringFromBundle("harvestclients.viewEditDialog.archiveDescription.default.generic" , BundleUtil.getCurrentLocale()));
